...
test:   
	make clean  
	make sudoku 
	./sudoku -t < test_1_input.txt > out.txt   
	sdiff --strip-trailing-cr out.txt test_1_output.txt  
	./sudoku -t < test_2_input.txt > out.txt   
	sdiff --strip-trailing-cr out.txt test_2_output.txt  
	./sudoku -t < test_3_input.txt > out.txt   
	sdiff --strip-trailing-cr out.txt test_3_output.txt  
